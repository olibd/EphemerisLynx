...
{
    public class InfoRequestTokenFactory<T> : TokenFactory<T> where T : InfoRequestToken, new()
	{
        ...
        public InfoRequestToken CreateInfoRequestTokenAsync(string encodedToken)
		{
